...
อัพเดทจาก `final-install-list.md` + รูปแบบที่พิสูจน์แล้ว (Obsidian memory vault + MCP + knowledge graph)

**ใช้ได้เลยกับโปรเจกต์ใหม่** — ไม่มีส่วนเฉพาะของโปรเจกต์ใด ๆ

---

## 1. Repo / Tool หลักที่ติดตั้ง (Core 3 ตัว)
...
### Understand-Anything หลังติดตั้ง
...
## 3. Project Memory ด้วย Obsidian (แนะนำมาก)
...
- [ ] ติดตั้ง 3 core tools (caveman + headroom + Understand-Anything)
- [ ] Restart IDE
